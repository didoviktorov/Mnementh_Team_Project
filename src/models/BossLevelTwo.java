...
public class BossLevelTwo extends DefaultObject implements BossEntity {
    ...
    public BossLevelTwo(double x, double y, Game game, Controller controller, int health, int damage) {
        super(x,y);
